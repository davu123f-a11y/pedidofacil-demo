...
export function BottomNavigation({
  ...
  return (
    <nav className="fixed inset-x-3 bottom-3 z-40 rounded-3xl border border-slate-200 bg-white/95 p-2 shadow-soft backdrop-blur lg:hidden">
        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={`relative grid gap-1 rounded-2xl px-2 py-2 text-xs font-bold transition ${
